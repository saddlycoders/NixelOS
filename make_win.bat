...
@echo Part 2.Compiling kernel
	...
	dev\compillers\mingw\bin\gcc -c boot/kernel/NixelDraw/string.c -o binary/string.o -Wall -Wextra -nostdlib -nostartfiles -nodefaultlibs -m32
	...
	dev\compillers\mingw\bin\ld -Tlink.ld -o binary/krnl.out binary/kernel.o binary/cls.o binary/CMOS.o binary/idt.o binary/shell.o binary/print.o binary/logs.o binary/kbd.o binary/VBE.o binary/tty.o binary/Speaker.o binary/io.o binary/console.o binary/graphics.o binary/kasm.elf
